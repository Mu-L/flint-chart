...
export const INTERACTION_PRESETS: { readonly [T in InteractionPresetType]: InteractionPresetDefinition<T> } = {
    ...
    'brush-zoom': {
        ...
        requires: INTERACTION_PRESET_REQUIREMENTS['brush-zoom'],
        gesture: 'drag',
        supportedReset: ANY_RESET,
    ...
    'linked-brush': {
        ...
        requires: INTERACTION_PRESET_REQUIREMENTS['linked-brush'],
        gesture: 'drag',
        requiredOptions: ['groupBy'],
        supportedReset: ANY_RESET,
        defaultReset: SELECTION_RESET,
    ...
    'legend-toggle': {
        ...
        requires: INTERACTION_PRESET_REQUIREMENTS['legend-toggle'],
        gesture: 'click',
        supportedReset: ANY_RESET,
    ...
    'context-activate': {
        ...
        requires: INTERACTION_PRESET_REQUIREMENTS['context-activate'],
        gesture: 'context',
        supportedReset: NEVER,
        defaultReset: NEVER,
    ...
    'long-press': {
        ...
        requires: INTERACTION_PRESET_REQUIREMENTS['long-press'],
        gesture: 'long-press',
        supportedReset: ANY_RESET,
        defaultReset: SELECTION_RESET,
        create: longPress,
    ...
    'double-activate': {
        ...
        requires: INTERACTION_PRESET_REQUIREMENTS['double-activate'],
        gesture: 'double',
        supportedReset: ANY_RESET,
        defaultReset: SELECTION_RESET,
    ...
    'inspect': {
        ...
        requires: INTERACTION_PRESET_REQUIREMENTS['inspect'],
        gesture: 'inspect',
        supportedReset: NEVER,
        defaultReset: NEVER,
        create: inspect,
    ...
    'inspect-index': {
        ...
        requires: INTERACTION_PRESET_REQUIREMENTS['inspect-index'],
        gesture: 'inspect',
        supportedReset: ANY_RESET,
        defaultReset: ['escape'],
        create: inspectIndex,
    ...
    'navigate': {
        ...
        requires: INTERACTION_PRESET_REQUIREMENTS['navigate'],
        gesture: 'navigate',
        supportedReset: ANY_RESET,
    ...
    'drag-reorder': {
        ...
        requires: INTERACTION_PRESET_REQUIREMENTS['drag-reorder'],
        gesture: 'drag',
        supportedReset: ANY_RESET,
        defaultReset: NO_RESET,
        create: dragReorder,
